<template>
  ...
  <button
    type="button"
    class="mt-8 float-right text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
  >
    <svg
            ...
            >
              <div class="bg-white px-2 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  >
                    <DocumentPlusIcon class="size-6 text-green-600" aria-hidden="true" />
                  </div>
